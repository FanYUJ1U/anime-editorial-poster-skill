...
English · 中文 · 版权与授权 · Copyright & permissions
...
update the README files if behaviour changes
...
generate the integrated visual composition

preserve clear typography zones

rebuild exact text in Photoshop, Illustrator, Figma, Canva, or another layout tool
...
再使用 Photoshop、Illustrator、Figma、Canva 等工具完成精确文字排版
